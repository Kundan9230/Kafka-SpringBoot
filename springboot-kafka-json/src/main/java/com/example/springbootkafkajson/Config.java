...
org.springframework.kafka.support.serializer.JsonDeserializer; import
...
map.put(ConsumerConfig.GROUP_ID_CONFIG, "id"); map.put(ConsumerConfig
...
(map, new StringDeserializer(), new JsonDeserializer<>(User.class)); 
}
